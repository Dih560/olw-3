<div>
    ...
    <div class="flex flex-col rounded-md border border-primary-200 p-4 divide-y divide-primary-200 divide-opacity-10">
        ...
        <div class="flex flex-row items-center py-2 gap-x-4">
            <span class="text-sm text-secondary-300 whitespace-nowrap w-[70px]">Contato</span>
            <span class="text-sm text-white">{{ $user->email }}</span>
        </div>

        <div class="flex flex-row items-center py-2 gap-x-4">
            <span class="text-sm text-secondary-300 whitespace-nowrap w-[70px]">Enviar para</span>
        ...
        <div class="flex flex-row items-center py-2 gap-x-4">
            <span class="text-sm text-secondary-300 whitespace-nowrap w-[70px]">Metodo</span>
            <span class="text-sm text-white">
