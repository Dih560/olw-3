<form id="form-checkout" x-show="$wire.method == 1">
    <div class="py-4 grid grid-cols-6 gap-x-4 gap-y-6 sm:grid-cols-8">
        <div class="col-span-4 sm:col-span-8">
            <x-input-label for="form-checkout__cardNumber" value="Numero do cartao"/>
            <div class="mt-1">
                <div
        ...
        <div class="col-span-2 sm:col-span-4">
            <x-input-label for="form-checkout__expirationDate" value="Vencimento"/>
            <div class="mt-1">
                <div
                    class="h-10 block w-full rounded-md text-primary-200 bg-tertiary-800 border-gray-300 shadow-sm focus:border-primary-200 focus:ring-primary-200 sm:text-sm"
                    type="text"
        ...
        <div class="col-span-2 sm:col-span-4">
            <x-input-label for="form-checkout__securityCode" value="CVC"/>
            <div class="mt-1">
                <div
                    class="h-10 block w-full rounded-md text-primary-200 bg-tertiary-800 border-gray-300 shadow-sm focus:border-primary-200 focus:ring-primary-200 sm:text-sm"
                    type="text"
        ...
        <div class="col-span-4 sm:col-span-8">
            <x-input-label for="form-checkout__cardholderName" value="Nome no Cartao"/>
            <div class="mt-1">
                <x-text-input
                    type="text"
